...
class TopUpApprovedEvent implements ShouldBroadcastNow
{
        ...
        return [
            'topup_request' => [
                ...
                'user' => [
                    ...
                    'balance' => $this->topupRequest->user->balance,
                ],
                'approver' => $this->topupRequest->approver ? [
                    'id' => $this->topupRequest->approver->id,
                    'name' => $this->topupRequest->approver->name,
                ] : null,
            ],
        ];
    }
